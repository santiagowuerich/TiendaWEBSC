...
export default async function Footer() {
  ...
  return (
    <footer className="text-neutral-500 dark:text-neutral-400">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 border-t border-neutral-200 px-6 py-12 text-base md:flex-row md:gap-12 md:px-4 min-[1320px]:px-0 dark:border-neutral-00">
        <div>
      ...
      <div className="border-t border-neutral-200 py-6 text-sm dark:border-neutral-00">
